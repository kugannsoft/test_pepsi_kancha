$(function() {
    ...
    function validate() {
        $('#result > span').text('');
        var msg, imei = $('#search_product').val(), r;
        ...
        if (imei !== '' && isIMEIValid(imei)) {
            ...
            msg = (r !== null)
                    ...
                    $("#search_product").css("background-color", "#00cc66");
                    $("#search_product").css("color", "#fff");
                    $('#result > span').css("color", "#00cc66");
        } else {
            msg = 'This is an invalid.';
            $("#search_product").css("background-color", "#ff8080");
            $("#search_product").css("color", "#fff");
            $('#result > span').css("color", "#f00");
        }
    ...
    $('#search_product').bind('keyup', function(e) {
