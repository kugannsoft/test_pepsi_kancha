        ...
        if (itemCode == '' || itemCode == 0) {
            ...
            if (is_serail == 0) {
                ...
                if (serialNo == '' || serialNo == 0) {
                    ...
                    $("#errProduct").show();
                    $('html, body').animate({scrollTop: $('#top').offset().top}, 'slow');
                    $("#errProduct").html('Serial Number already added.').addClass('alert alert-danger alert-dismissible alert-sm').delay(1500).fadeOut(600);
                    $("#serialNo").val('');
                    return false;
                } else if (((StockserialNoArrIndex < 0 && is_serail == 1))) {
                    $("#errProduct").show();
                    $('html, body').animate({scrollTop: $('#top').offset().top}, 'slow');
                    $("#errProduct").html('Serial Number product not in  stock.').addClass('alert alert-danger alert-dismissible alert-sm').delay(1500).fadeOut(600);
                    $("#serialNo").val('');
                    return false;
                }
...
//        customer_payment = cash_amount + cheque_amount + credit_amount + return_amount;
        ...
        if (r == true) {
            if ((rowCount - 1) == '0' || (rowCount - 1) == '') {
                $("#errData").show();
                    $('html, body').animate({scrollTop: $('#saveItems').offset().top}, 'slow');
                ...
                $("#errData").show();
                    $('html, body').animate({scrollTop: $('#saveItems').offset().top}, 'slow');
                    $("#errData").html('Please Select a destination location.').addClass('alert alert-danger alert-dismissible alert-sm').delay(1500).fadeOut(600);
                 return false;
            } else {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (feedback != 1) {
                            $("#errData").show();
                    $('html, body').animate({scrollTop: $('#saveItems').offset().top}, 'slow');
                    $("#errData").html('Transaction not saved successfully.').addClass('alert alert-danger alert-dismissible alert-sm').delay(1500).fadeOut(600);
                  $("#loadBarCode").hide();
                            $("#dwnLink").hide();
                           ...
                           $("#errData").show();
                    $('html, body').animate({scrollTop: $('#saveItems').offset().top}, 'slow');
                    $("#errData").html('Transaction saved successfully.').addClass('alert alert-success alert-dismissible alert-sm').delay(1500).fadeOut(600);
