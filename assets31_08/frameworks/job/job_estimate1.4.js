$(document).ready(function() {
    ...
    function setGridandLabelData(data) {
        if (data.cus_data) {
            ...
            $("#cusName,#lblCustomer").html("<a href='"+encode_url+"'>"+data.cus_data.CusName+"</a>");
...
var partType = '';
    ...
    $("#btnSave").click(function() {
        ...
        if(cusCode=='' || cusCode==0){
            ...
            return false;
        }else if(job_type=='' || job_type==0){
            $.notify("Please select a Type.", "danger");
            return false;
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (fb) {
                        ...
                        $.notify("estimate successfully saved.", "success");
            ...
            $.notify("Please add descriptions..", "danger");
        }
    ...
    function loadCustomerDatabyId(customer) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#cusName,#lblCustomer").html("<a href='"+encode_url+"'>"+resultData.cus_data.CusName+"</a>");
