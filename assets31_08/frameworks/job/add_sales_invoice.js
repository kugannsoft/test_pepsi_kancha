        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (resultData.advance){
                    ...
                    addPayment(cashAmount, creditAmount, cardAmount,chequeAmount,cusType,advance_amount,return_amount);
                }
            }
        });
    }
...
function addPayment(pcash, pcredit, pcard,pcheque,pcusType,padvance,preturn) {

    dueAmount = totalNetAmount - parseFloat(pcash + pcard+pcheque+pcredit+padvance+preturn);
        ...
        cusTotal=parseFloat(pcash + pcard+pcheque+pcredit+padvance+preturn);
        ...
        $("#mreturn").html(accounting.formatMoney(preturn));
