...
//load edit grid data
    $("#tbl_job tbody").on('click', '.edit', function() {
        ...
        var selprice = $(this).parent().parent().attr('cost_price');
        var costprice = $(this).parent().parent().attr('sellprice');
...
$("input[name='isTotalNbt']").on('ifChanged', function(event){
    ...
    function genarateInvLink(est,sup){
        ...
        $("#invLink").attr("href","../../../admin/Salesinvoice?type=est&id="+Base64.encode(est)+"&sup="+sup);
    }
