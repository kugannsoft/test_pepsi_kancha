$(document).ready(function() {
    ...
    function setGridandLabelData(data) {
        ...
        if (data.job_data) {
            ...
            $("#vehicleCompany").val(data.est_hed.EstInsCompany);
...
var partType = '';
    ...
    $("#btnSave").click(function() {
        ...
        $("#modelNotifi").html('');
        if((jobNo=='' || jobNo==0) && (cusCode=='' || cusCode==0)){
            ...
            success: function(data) {
                ...
                if(resultData.est_hed.EstJobType==1){
                    $.each(resultData.est_dtl, function(key, value) {
                        $("#tbl_est_data").append("<tr><td class='bordertopbottom'></td><td class='bordertopbottom' style='padding: 1px 3px 1px 50px;'><b>" + key + "</b></td><td class='bordertopbottom'></td><td class='bordertopbottom'></td><td class='bordertopbottom'></td></tr>");
