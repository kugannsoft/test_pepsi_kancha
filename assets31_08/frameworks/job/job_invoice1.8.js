    ...
    $("#btnSave").click(function() {
        ...
        if((jobNo=='' || jobNo==0) && (cusCode==''  && regNo=='')){
            ...
            $.ajax({
                ...
                type: "POST",
                data: { action: action,remark:remark ,mileageout:mileageout,mileageoutUnit:mileageoutUnit,com_amount:com_amount, compayto:compayto,receiver_name:receiver_name,receiver_nic:receiver_nic,InvoiceType:InvoiceType,partInvType:partInvType, date: esdate, estimateNo: estimateNo,invoiceNo: invoiceNo,tempInvoiceNo:tempInvoiceNo, remark: remark, estimateAmount: totalAmount, insCompany: insCompany, cusCode: cusCode, regNo: regNo, sup_no: supNum, jobNo: jobNo, job_type: job_type, estimate_type: estimate_type, net_price: net_priceArr, qty: qtyArr, sell_price: sell_priceArr, is_ins: is_insArr, insurance: insuranceArr, desc: descArr, job_id: job_idArr, job_order: job_orderArr, work_id: work_idArr, estLineNo:estLineNoArr, timestamp: timestampArr,isVat:isVatArr,isNbt:isNbtArr,nbtRatio:nbtRatioArr,proVat:proVatArr,proNbt:proNbtArr,totalPrice:totalPriceArr,proDiscount:proDiscountArr,disPercent:disPercentArr,discountType:disTypeArr,estPrice:estimatePriceArr,costPrice:costPriceArr,
                nbtRatioRate: nbtRatioRate,isTotalVat:isTotalVat,isTotalNbt:isTotalNbt,totalNet:totalNet,totalAmount:totalAmount,totalVat:finalVat,totalNbt:finalNbt,total_discount:total_discount,bankacc:bankacc,bank_amount:bank_amount,cashAmount:cashAmount,creditAmount:creditAmount,chequeAmount:chequeAmount,cardAmount:cardAmount,advance_amount:advance_amount,advance_pay_no:advance_payment_no,ccAmount: ccAmountArr, ccRef: ccRefArr, ccType: ccTypeArr, ccName: ccNameArr,chequeNo:chequeNo,bank: bank, chequeReference: chequeReference, chequeRecivedDate: chequeReciveDate, chequeDate: chequeDate,pay_remark:pay_remark},
                success: function(data) {
...
function addPayment(pcash, pcredit, pcard,pcheque,pcusType,padvance,pbank) {
    ...
    dueAmount = totalNet - parseFloat(pcash + pcard+pcheque+pcredit+padvance+pbank);
