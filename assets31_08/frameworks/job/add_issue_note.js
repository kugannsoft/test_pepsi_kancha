...
//    $("#panel_quarter").hide();
    ...
    if (poNumber != '') {
        $.ajax({
            type: "POST",
            url: baseUrl+'/Salesinvoice/getCustomersDataByJob',
            data: { jobNo: poNumber },
            success: function(data) {
                var resultData = JSON.parse(data);
                loadCustomerDatabyId(resultData.jobDtl.CusCode);
            }
        });
    ...
    $("#grn_no").autocomplete({
        source: function(request, response) {
            $.ajax({
                url: baseUrl+'/salesinvoice/loadsalesinvoicejson',
                dataType: "json",
                data: {
                    q: request.term
                },
    ...
    $("#soNo").autocomplete({
        source: function(request, response) {
            $.ajax({
                url: baseUrl+'/salesinvoice/loadsalesorderjson',
                dataType: "json",
                data: {
                    q: request.term
                },
    ...
    function loadReturnData(pay_no){
        $.ajax({
            type: "POST",
            url:baseUrl+'/Salesinvoice/getreturnpaymentbyid',
            data: { payid: pay_no },
            success: function(data) {
                var resultData = JSON.parse(data);
    ...
    function loadSAlesInvoice(po_no){
        $.ajax({
            type: "POST",
            url: baseUrl+'/Salesinvoice/getIssueNoteById',
...
//===============save products ==============================
    $("#saveItems").click(function() {
        ...
        var r = confirm("Do you want to save this Issue Note.?");
        if (r == true) {
            if (cusCode == '' || cusCode == '0') {
                ...
                $.ajax({
                    type: "post",
                    url: baseUrl+'/Salesinvoice/saveIssueNote',
                    ...
                    success: function(data) {
                        ...
                        if (feedback != 1) {
                            $.notify("Issue Note not saved successfully.", "warning");
                            ...
                            var invlink = baseUrl+'/Salesinvoice/view_issue_note/'+Base64.encode(invNumber);
                            $("#lastInvoice").html("<a href='"+invlink+"'>Last Issue Note - "+invNumber+"</a>");
                            $("#btnPrint").attr('link',invlink);
                            $.notify("Issue Note saved successfully.", "warning");
                            $("#tbl_item tbody").html('');
                            loadSAlesInvoice(invNumber);
    ...
    function loadSalesInvoiceDatatoGrid(resultData) {
        ...
        if (resultData.si_hed){
            ...
            var invlink =  baseUrl+'/Salesinvoice/view_issue_note/'+Base64.encode(poNo);
            $("#lastInvoice").html("<a href='"+invlink+"'>Last Issue Note - "+poNo+"</a>");
            $("#btnPrint").attr('link',invlink);
...
//customer autoload
    ...
    $('#regNo').on('select2:select', function (e) {
        ...
        $.ajax({
            type: "POST",
            url: baseUrl+'/Job/getVehicleDetailsById',
            data: { id: regNo },
            success: function(data) {
                var resultData = JSON.parse(data);
                if (resultData) {
