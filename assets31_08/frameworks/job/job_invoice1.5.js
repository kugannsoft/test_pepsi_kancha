...
//remove row from table
    ...
    $("#btnSave").click(function() {
        ...
        $('#tbl_job tbody tr').each(function(rowIndex, element) {
            ...
            mileageout.push($(this).attr('mileageout'));
            mileageoutUnit.push($(this).attr('mileageoutUnit'));
        });
        ...
        var mileageoutUnit = $("#mileageoutUnit").val();
        ...
        if((jobNo=='' || jobNo==0) && (cusCode==''  && regNo=='')){
            ...
            $.ajax({
                ...
                nbtRatioRate: nbtRatioRate,isTotalVat:isTotalVat,isTotalNbt:isTotalNbt,totalNet:totalNet,totalAmount:totalAmount,totalVat:finalVat,totalNbt:finalNbt,total_discount:total_discount,mileageout:mileageout,mileageoutUnit:mileageoutUnit},
                success: function(data) {
