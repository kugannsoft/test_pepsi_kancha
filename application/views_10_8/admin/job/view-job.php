                    ...
                    [
                        {
                            ...
                            mRender: function (data, type, row) {
                                return '<a href="../job/view_job_card/'+ Base64.encode(row.JobCardNo) +'"  >'+row.JobCardNo+'</a>';
                            }
                            <?PHP  } else {?>
                            "data": null, orderable: false, searchable: false,
                            mRender: function (data, type, row) {
                        ...
                        },
                        {
                            ...
                            mRender: function (data, type, row) {
                                if(row.IsCancel==1){
                                   return '<a href="../job/view_job_card/'+ Base64.encode(row.JobCardNo) +'" class="btn btn-xs btn-info" >View</a>';
                                }else if(row.IsCancel==0){
                                    return '<a href="../job/view_job_card/'+ Base64.encode(row.JobCardNo) +'" class="btn btn-xs btn-info" >View</a>';
                                }
                            }
                            ...
                            mRender: function (data, type, row) {
                                if(row.IsCancel==1){
                                    return '<a href="../job/view_job_card/'+ Base64.encode(row.JobCardNo) +'" class="btn btn-xs btn-info" disabled>View</a>';
                                }else if(row.IsCancel==0){
                                    return '<a href="../job/view_job_card/'+ Base64.encode(row.JobCardNo) +'" class="btn btn-xs btn-info" disabled>View</a>';
                                }
                            }
                        ...
                        },
                        {
                            ...
                            mRender: function (data, type, row) {
                                if(row.IsCancel==1){
                                    return '<a href="#" disabled class="btn btn-xs btn-info" >Edit</a>';
                                }else if(row.IsCancel==0){
                                    return '<a href="../job/edit_job/'+ Base64.encode(row.JobCardNo) +'" class="btn btn-xs btn-info" >Edit</a>';
                                }
                            }
                            <?PHP  } else {?>
                            "data": null, orderable: false, searchable: false,
                            mRender: function (data, type, row) {
                                if(row.IsCancel==1){
                                    return '<a href="#" disabled class="btn btn-xs btn-info" disabled>Edit</a>';
                                }else if(row.IsCancel==0){
                                    return '<a href="../job/edit_job/'+ Base64.encode(row.JobCardNo) +'" class="btn btn-xs btn-info" disabled>Edit</a>';
                                }
                            }
                            <?php }?>
                        },
                        {
                            <?php if (in_array("M3", $blockDelete) || $blockDelete == null) { ?>
                            "data": null, orderable: false, searchable: false,
                            mRender: function (data, type, row) {
                                 if(row.IsCancel==1){
                            ...
                            mRender: function (data, type, row) {
                                if(row.IsCancel==1){
                                    return '<a href="#" disabled class="btn btn-xs btn-danger" disabled>Cancel</a>';
                                }else if(row.IsCancel==0){
                                    return '<a href="../job/cancel_job/'+ Base64.encode(row.JobCardNo) +'" class="btn btn-xs btn-danger" disabled>Cancel</a>';
                                }
                            }
                            <?php }?>
                        }
