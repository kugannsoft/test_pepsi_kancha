            ...
            "columns":
                    [
                        ...
                        {"data": null, orderable: false, searchable: false,
                            mRender: function (data, type, row) {
                                 if(row.IsCancel==1){
                                return '<a href="../job/estimate_job/'+ Base64.encode(row.JobCardNo) +'" class="btn btn-xs btn-primary" disabled>Estimate</a>&nbsp;<a href="../Salesinvoice/job_invoice?type=job&id='+ Base64.encode(row.JobCardNo) +'" class="btn btn-xs btn-primary" disabled>Invoice</a>';
                                }else if(row.IsCancel==0){
                                     return '<a href="../job/estimate_job/'+ Base64.encode(row.JobCardNo) +'" class="btn btn-xs btn-primary" >Estimate</a>&nbsp;<a href="../Salesinvoice/job_invoice?type=job&id='+ Base64.encode(row.JobCardNo) +'" class="btn btn-xs btn-primary" >Invoice</a>';
                                }
                            }
                        },
                        {"data": null, orderable: false, searchable: false,
                            mRender: function (data, type, row) {
                                if(row.IsCancel==1){
                                return '<a href="../job/view_job_card/'+ Base64.encode(row.JobCardNo) +'" class="btn btn-xs btn-info" >View</a>&nbsp;&nbsp;<a href="../job/edit_job/'+ Base64.encode(row.JobCardNo) +'" class="btn btn-xs btn-info" disabled>Edit</a>';
                                 }else if(row.IsCancel==0){
