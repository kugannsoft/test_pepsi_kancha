    ...
    <input type="hidden" name="inv" id="inv" value="<?php echo $invNo;?>">
        <div class="row"  align="center" style='margin:5px;'>
            ...
            <tr style="text-align:left;font-size:13px;">
                <td> Address</td>
                <td> :</td>
                <td rowspan="3" id="lblAddress" valign="top"><?php echo nl2br($invCus->Address01).",<br>";?></td>
                <td> Tel</td>
                <td> :</td>
            ...
            <tr style="text-align:left;font-size:13px;">
                ...
                <td > </td>
                <td> </td>
                <td id="lblNextMeter"> &nbsp;</td>
            </tr>
            <tr style="text-align:left;font-size:13px;">
                <td colspan="6">&nbsp;</td>
            </tr>
        </table>
                      <table id="tbl_est_data" style="border-collapse:collapse;width:690px;padding:5px;font-size:14px;" border="1">
                          <thead>
                              <tr>
                                  <th style='padding: 3px;width:20px;'>Item</th>
                                  <th style='padding: 3px;width:300px;' colspan="2">Description</th>
                          ...
                          // var_dump($invDtl);die;
                              ...
                              <td class='text-right'><?php echo number_format($inv->JobQty,0)?></td>
                          ...
                          <tfoot>
                              ...
                              <?php } ?>
                               <?php if($invHed->JobNbtAmount !=0 || $invHed->JobAdvance !=0 || $invHed->JobVatAmount !=0 || $invHed->JobTotalDiscount !=0){?>
...
<!--  <tr style="text-align:center;font-size:35px;font-family: Arial, Helvetica, sans-serif;">
            ...
            <tr style="text-align:center;font-size:14px;border-bottom: #000 solid 1px;padding-bottom:5px;">
                <td colspan="6">VAT NO : 104058787 7000</td>
            </tr> -->
            <tr style="text-align:left;font-size:13px;">
                <td> Customer Code</td>
                <td> :</td>
