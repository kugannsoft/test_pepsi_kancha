        ...
        <div class="row">
             <div class="col-md-8">
                    ...
                    <select name="jobCardCategory" id="jobCardCategory" class="form-control">
                        ...
                        <option value="<?php echo $trns->rack_id; ?>" <?php if($trns->rack_id==$trans->store_rack){echo 'selected';} ?>><?php echo $trns->rack_no; ?></option>
                        <?php } ?>
                    </select>
                </div>
            <div class="col-md-8">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" required="required" value="<?php echo $trans->bin_no?>"  name="name" id="name">
                </div>
               
                <div class="form-group">
                    
                    <input type="hidden" value="<?php echo $trans->store_id?>" name="id" id="id">
                </div>
...
<script>
    ...
    $('#addproductform').submit(function(e) {
        ...
        e.preventDefault();
        $.ajax({
            url: "<?php echo base_url('admin/master/editBinNo/') ?>",
            type: "POST",
