            ...
            <div class="col-lg-12">
                <div class="box box-success">
                    <div class="box-header">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="customer" class="col-sm-5 control-label">PO No <span class="required">*</span></label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" required="required"  name="invoice" id="invoice" placeholder="Enter PO number">
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <br><button class="btn btn-info pull-right" id='pay'>Cancel PO</button>
                            </div>
                            <div class="col-lg-8">
                    ...
                    <div class="box-body">
                        ...
                        <span id="lastTranaction">Last Cancel PO : </span>
                    </div><!-- /.box-body -->
                </div><!-- /.box -->
            </div>
        </div>
