...
//load invoice data to grid
    ...
    function loadTempInvoiceDatatoGrid(resultData) {
        ...
        if (resultData.inv_dtl!=null || resultData.inv_dtl!=''){
            ...
            total_discount= parseFloat(resultData.inv_hed.JobTotalDiscount);
            if(totalProWiseDiscount>0){
            totalNet=parseFloat(totalNetAmount+totalVat+totalNbt-total_discount+totalProWiseDiscount);

            }else{
            totalNet=parseFloat(totalNetAmount+totalVat+totalNbt-total_discount);
