    ...
    <input type="hidden" name="inv" id="inv" value="<?php echo $invNo;?>">
        <div class="row"  align="center" style='margin:5px;'>
            ...
            <?php $noofjob=0;$refno=0; ?>
                      ...
                      <table id="tbl_est_data2" style="border-collapse:collapse;width:690px;padding:5px;font-size:13px;" border="1"> 
                          <tbody>
      ...
      <button id="chequePrint" <?php if($cheque_pay==''){?><?php } ?> class="btn btn-primary">Cheque Receipt Print</button>
...
<div class="modal fade bs-payment-modal-lg" id="modelInvoice5" tabindex="-1" role="dialog" aria-hidden="false">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content"><div class="modal-body" >
                    <div class="row" id="printArea5" align="center" style='margin:5px;'>
                    <style type="text/css">
                    @page  
{ 
    size: auto;
                           ...
                           <tr>
                              <th class="report-header-cell">
                                 <div class="header-info" >
                                    <table  style="font-family: times;width:690px;font-size:13px;" >
                                                    <!--  <tr style="line-height: 25px"> 
                            <td style="border-top: 1px solid #fff;border-left: 1px solid #fff;border-right: 1px solid #fff;" colspan="7">&nbsp;</td></tr>
 -->
                        <tr > 
                            <td style="width:20px;border-top: 1px solid #fff;border-left: 1px solid #fff;border-right: 1px solid #fff;">&nbsp;</td>
                            <td style="width:280px;text-align: center;border-top: 1px solid #fff;border-left: 1px solid #fff;border-right: 1px solid #fff;"><span id="invType" style="font-size: 20px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><?php if($invHed->InvoiceType==1){?>CASH <?php }elseif($invHed->InvoiceType==2){ ?> TAX <?php } ?><br>
                                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;INVOICE</b></span></td>
                            <td style="width:20px;border-top: 1px solid #fff;border-left: 1px solid #fff;border-right: 1px solid #fff;">&nbsp;</td>
                            <td style="width:60px;border-top: 1px solid #fff;border-left: 1px solid #fff;border-right: 1px solid #fff;">&nbsp;</td>
                            <td style="width:80px;border-top: 1px solid #fff;border-left: 1px solid #fff;border-right: 1px solid #fff;" class='text-right'>&nbsp;</td>
                          ...
                          <tr>
                            <td style="width:20px;border-top: 1px solid #fff;border-left: 1px solid #fff;border-right: 1px solid #fff;">&nbsp;</td>
                            <td style="width:280px;text-align: right;border-top: 1px solid #fff;border-left: 1px solid #fff;border-right: 1px solid #fff;">VAT NO : 1040587877000&nbsp;&nbsp;</td>
                            <td style="width:20px;border-top: 1px solid #fff;border-left: 1px solid #fff;border-right: 1px solid #fff;">&nbsp;</td>
                            <td style="width:60px;border-top: 1px solid #fff;border-left: 1px solid #fff;border-right: 1px solid #fff;">&nbsp;</td>
                            <td style="width:80px;border-top: 1px solid #fff;border-left: 1px solid #fff;border-right: 1px solid #fff;" class='text-right'>&nbsp;</td>
                            <td style="width:50px;border-top: 1px solid #fff;border-left: 1px solid #fff;border-right: 1px solid #fff;" class='text-right'>&nbsp;</td>
                          ...
                          <!-- <tr>
                            ...
                            <td style="width:50px;" class='text-right' style="width:70px"></td>
                          </tr> -->
                          
                          <tr>
                            <td style="text-align:left;font-size:12px;padding-top:25px;border-top: 1px solid #fff;border-left: 1px solid #fff;border-right: 1px solid #fff;" colspan="2" >
                                <span id="lblcusCode"><?php echo $invHed->customerCode;?></span> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Contanct Name <span id="lblConName"> <?php echo $invVehi->contactName;?></span><br>
                                <span id="lblcusName"><?php echo $invCus->RespectSign.", ".$invCus->CusName;?></span><br>
                                <span id="lblcusName"><?php echo nl2br($invCus->Address01);?></span><br>
                                 Tel : <span id="lblcusName"><?php echo $invCus->MobileNo." ".$invCus->LanLineNo;?></span><br>
                                
                            </td>
                            <td style="font-size:11px;padding-top: 15px;border-top: 1px solid #fff;border-left: 1px solid #fff;border-right: 1px solid #fff;" colspan="5" >
                              Date &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;<span id="lblinvDate"> <?php echo $invHed->date;?></span><br>
                              Invoice No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;<span id="lblInvNo"> <?php echo $invHed->JobInvNo;?></span><br>
                              Reg No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;<span id="lblregNo"> <?php echo $invHed->regNo;?></span><br>
                              Job No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;<span id="lbljobNo"><?php echo $invHed->jobcardNo; ?></span><br>
                              Mileage  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;<span id="lblviNo"> <?php echo $invjob->OdoIn;?></span><br>
                              Chassis No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;<span id="lblviNo"> <?php echo $invVehi->ChassisNo;?></span><br>
                              Make  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;<span id="lblmake"><?php echo $invVehi->make;?></span><br>
                              Model  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;<span id="lblmodel"><?php echo $invVehi->model;?></span><br>
                            </td>
                          </tr>
                          <tr style="line-height: 15px">
                                  <td style="width:20px;border-top: 1px solid #fff;border-left: 1px solid #fff;border-right: 1px solid #fff;">&nbsp;</td>
                                  <td style="width:280px;border-top: 1px solid #fff;border-left: 1px solid #fff;border-right: 1px solid #fff;">&nbsp;</td>
                                  <td style="width:20px;border-top: 1px solid #fff;border-left: 1px solid #fff;border-right: 1px solid #fff;">&nbsp;</td>
                                  <td style="width:60px;border-top: 1px solid #fff;border-left: 1px solid #fff;border-right: 1px solid #fff;">&nbsp;</td>
                                  <td style="width:80px;border-top: 1px solid #fff;border-left: 1px solid #fff;border-right: 1px solid #fff;" class='text-right'>&nbsp;</td>
                                  <td style="width:50px;border-top: 1px solid #fff;border-left: 1px solid #fff;border-right: 1px solid #fff;" class='text-right'>&nbsp;</td>
                          ...
                          <tbody class="report-content">
                            <tr>
                               <td class="report-content-cell">
                                  <div class="main">
                                  <table id="tbl_est_data" style="font-family: times;width:690px;padding:5px;font-size:13px;" border="1">
                                   <tbody>
                          ...
                          <tbody>
                            ...
                            <tr><td style="text-align: left;width:100px;"><b>Remarks</b></td><td colspan="6">&nbsp;</td></tr>
                            <tr><td colspan="7"  style="border:1px solid #000;height: 30px;">&nbsp;</td></tr>
                            <tr><td style="font-size: 11px;"><?php echo date('d-m-Y');?></td><td colspan="5"  style="">&nbsp;</td><td style="font-size: 11px;text-align: right;" class="pagenum"></td></tr>
...
<thead style="margin-top:10px;">
                        <tr > 
    <td style="border-top: 1px solid #fff;border-left: 1px solid #fff;border-right: 1px solid #fff;height: 20px;" colspan="7">&nbsp;</td></tr>
...
<tr > 
  ...
  <tfoot>
    <!-- <tr><td colspan="7"><table style="width:683px;padding:2px; " border="0">
  <tbody>
     <tr><td colspan="7">&nbsp;</td></tr>
     <tr><td colspan="7">&nbsp;</td></tr>  
     <tr><td colspan="7">&nbsp;</td></tr>
