...
@media print
{
  ...
  tfoot { display:table-footer-group }
                      ...
                      <table id="tbl_est_data" style="border-collapse:collapse;font-family: times;width:690px;padding:5px;font-size:13px;" border="1"> 
                        <thead>
                        ...
                        <tr > 
                          ...
                          // var_dump($invDtl);die;
                                 foreach ($invDtl AS $key=>$invdata) { ?>
                                <tr style="line-height: 2px"><td style="border-top: 1px solid #000;border-bottom: 1px solid #000;"></td><td colspan="2" style="border-top: 1px solid #000;border-bottom: 1px solid #000;"><b><?php echo $key?></b></td><td style="border-top: 1px solid #000;border-bottom: 1px solid #000;"></td><td style="border-top: 1px solid #000;border-bottom: 1px solid #000;"></td><td colspan="2" style="border-top: 1px solid #000;border-bottom: 1px solid #000;"></td></tr>
                                       <?php foreach ($invdata AS $inv) { ?>
