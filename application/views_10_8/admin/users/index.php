                                    ...
                                    <table class="table table-striped table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo lang('users_role');?></th>
                                                <th><?php echo lang('users_com');?></th>
                                                <th><?php echo lang('user_branch');?></th>
                                        ...
                                        <?php foreach ($users as $user):?>
                                            <tr>
                                                ...
                                                <td><?php echo htmlspecialchars($user->user_role, ENT_QUOTES, 'UTF-8'); ?></td>
                                                <td><?php echo htmlspecialchars($user->company_name, ENT_QUOTES, 'UTF-8'); ?></td>
                                                <td><?php echo htmlspecialchars($user->user_branch, ENT_QUOTES, 'UTF-8'); ?></td>
                                                <!-- <td>
                                        ...
                                        <?php endforeach?>
                                                ...
                                                <td>
                                                    <?php echo anchor('admin/users/edit/'.$user->id, '<span class="btn btn-primary btn-xs">'.lang('actions_edit').'</span>'); ?>&nbsp;
                                                    <?php echo anchor('admin/users/profile/'.$user->id, '<span class="btn btn-warning btn-xs">'.lang('actions_see').'</span>'); ?>
                                                </td>
                                            </tr>
                                        <?php endforeach;?>
                                        </tbody>
