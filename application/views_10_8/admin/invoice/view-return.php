...
<div class="content-wrapper" id="app">
    <section class="content-header">
        ...
        <!--  <button type="button" <?php echo $disabled;?> id="btnCancel" class="btn btn-danger btn-lg btn-block">Cancel Delivery</button> -->
        </div>
        <div class="pull-right">
...
<table style="border-collapse:collapse;width:700px;margin:5px;font-family: Arial, Helvetica, sans-serif;" border="0">
    <tr style="text-align:left;font-size:13px;">
        <td > &nbsp;</td>
        <td> &nbsp;</td>
        <td colspan="3" style="text-align:center;font-size:20px;font-weight: bold;" >Return Invoice</td>
    </tr>
    <tr style="text-align:left;font-size:13px;">
        <td> &nbsp;</td>
        <td></td>
...
<table id="tbl_po_data" style="border-collapse:collapse;width:700px;padding:5px;font-size:13px;" border="1">
  <thead id="taxHead">
    ...
    <tr>
      ...
      <th style='padding: 3px;width:80px'>Return Amount</th>
    </tr>
  </thead>
  <tbody>
    <?php 
      ...
      <?php $i++; 
         ...
         <tr>
            ...
            <td ><b><?php echo $invHed->ReturnAmount;?></b></td>
          </tr>                 
    </tbody>
  </table>
  <table style="width:700px;" border="0">
   <tr><td colspan="5" style="text-align:right;">&nbsp;</td></tr>
    ...
    <tr>
        <td style="width:100px;text-align: center">Returned By</td>
        <td style="">&nbsp;</td>
