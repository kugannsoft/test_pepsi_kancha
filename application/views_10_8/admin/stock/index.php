...
<?php } ?>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group" >
                                <button type="button"  class="btn btn-warning btn-lg btnlg" id="savePrint" style="margin-bottom:0px;width: 100%;">
                             ...
                             <div class="form-group" role="group">
                                <button data-target="#modelPayment" type="button"  data-toggle="modal" class="btn btn-primary btn-lg btnlg" id="cart-pay-button" style="margin-bottom:0px;width: 100%;">
                                    <i class="fa fa-money"></i>
                                    Payment            
                                </button>
                            </div>
                            <div class="form-group" role="group">
                                <button data-target="#modelTotalDis" type="button"  data-toggle="modal" class="btn btn-success btn-lg btnlg" id="cart-discount-button" style="margin-bottom:0px;width: 100%;">
                                    <i class="fa fa-gift"></i>
                                    Discount			
                                </button>
                            </div>
                            <div class="form-group" role="group">
                                <button type="button" class="btn btn-danger btn-lg btnlg" id="cart-return-to-order" style="margin-bottom:0px;width: 100%;"> <!-- btn-app  -->
                            ...
                            <form class="form-horizontal">
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group" id="dv_FreeQty">
                                        ...
                                        <input type="hidden"  name="mIsFree" id="mIsFree" value="0" ></div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="discount_value" id="totalAmountDiscount" class="form-control input-lg" min="0" value=""  step="5"  placeholder="Define the amount or percentage here...">
