                        ...
                        <div class="box-body table-responsive">
                            <table id="saletable" class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th id="totalpr" style="color:#f00;font-weight:bold;text-align: right" colspan="2"></th>
...
<script>
    ...
    function drawRow(rowData) {
        ...
        row.append($("<td class='totalreturn' align='right'>" + accounting.formatMoney(rowData.ReturnAmount) + "</td>"));
