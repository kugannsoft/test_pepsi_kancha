...
<script>
    ...
    function drawRow(rowData) {
        ...
        row.append($("<td><a href='<?php echo base_url() ?>admin/Salesinvoice/view_issue_note/"+Base64.encode(rowData.SalesInvNo)+"' >" + rowData.SalesInvNo + "</a></td>"));
        row.append($("<td>" + rowData.SalesPONumber + "</td>"));
