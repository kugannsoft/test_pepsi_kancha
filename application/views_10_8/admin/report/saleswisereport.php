                            ...
                            $.each(data, function(index, item) {
                                ...
                                $('#saletable tbody').append(`
                                    ...
                                    <tr>
                                        ...
                                        <td>${item.SalesCashAmount}</td>
                                        <td>${item.SalesCreditAmount}</td>
                                        <td>${item.SalesInvAmount}</td>
                                        <td>${item.SalesDisAmount}</td>
                                        <td>${item.SalesNetAmount}</td>
