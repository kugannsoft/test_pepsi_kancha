...
$("input[name='isall']").on('ifChanged', function(event){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data){
                    ...
                    if(res.cr2!=''){
                        drawTable(res.cr2);
                        $('#cusName').html(res.cr2[0].RespectSign+' '+res.cr2[0].CusName);$('#address1').html(res.cr2[0].Address01);
                        $('#address2').html(res.cr2[0].Address02);
                    }
    ...
    function drawRow(rowData) {
        ...
        row.append($("<td class='profit' align='right'>" + accounting.formatMoney(rowData.commission) + "</td>"));
    }
