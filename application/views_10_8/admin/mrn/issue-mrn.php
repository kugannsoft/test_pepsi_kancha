                        ...
                        <div class="col-md-4">
                            <form class="form-horizontal" >
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" tabindex="1" class="form-control"  name="grn_no" id="grn_no" placeholder="MRN No">
                                    </div>
                                </div>
                                <div class="form-group">
...
<!--                                        <div class="col-sm-6">-->
<!--                                            <input type="text" tabindex="1" readonly class="form-control" name="job_no" id="job_no" placeholder="Job No">-->
                                            <input type="hidden" tabindex="1" readonly class="form-control" name="job_no" id="job_no" placeholder="Job No">
<!--                                        </div>-->
<!--                                    </div>-->
<!--                                <div class="form-group">-->
<!--                                    <label class="col-sm-4 control-label">Estimate Number</label>  -->
<!--                                    <div class="col-sm-6">-->
<!--                                        <input type="text" tabindex="1" readonly class="form-control" name="est_no" id="est_no" placeholder="Estimate No">-->
                                        <input type="hidden" tabindex="1" readonly class="form-control" name="est_no" id="est_no" placeholder="Estimate No">
<!--                                    </div>-->
<!--                                </div>                                -->
                                <div class="form-group" style="display: none;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select tabindex="3" class="form-control" id="location_from" readonly="readonly" disabled="disabled">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                        <div class="col-md-6">
                            <h5 class="text-center"><b>MRN Request List</b></h5>
                        ...
                        <div class="col-md-6">
                        <h5 class="text-center"><b>MRN Issue List</b></h5>
                            <div class="table-responsives">
                                <table id="tbl_item2" class="table table-bordered table-striped table-responsives">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Product Code</th>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="hidden" class="form-control" required="required"  name="isVat" id="isVat">
                                                <input type="hidden" class="form-control" required="required"  name="isNbt" id="isNbt">
                                                <input type="hidden" class="form-control" required="required"  name="nbtRatio" id="nbtRatio">
                                                <input type="hidden" class="form-control" required="required"  name="vatAmount" id="vatAmount">
                                                <input type="hidden" class="form-control" required="required"  name="nbtAmount" id="nbtAmount">
                                                <input type="hidden" class="form-control" required="required"  name="netAmount" id="netAmount">
                                                <input type="hidden" class="form-control" required="required"  name="totalAmount" id="totalAmount">
                                                <input type="hidden" class="form-control" required="required"  name="rowid" id="rowid">
                                            </div>
                                        </div>
