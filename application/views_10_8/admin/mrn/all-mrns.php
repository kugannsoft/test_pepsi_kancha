            ...
            <div class="col-md-12">
                <div class="box">
                    ...
                    <b><span class="alert alert-success pull-left" id="lastProduct"></span></b>
                        <a href="<?php echo base_url('admin/mrn/add_mrn'); ?>" class="btn btn-flat btn-primary pull-right">Add Mrn</a>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
	...
	"columns":
	        [
	            ...
	            {"data": null, orderable: false, searchable: false,
	                mRender: function (data, type, row) {
                        if(row.MrnIsReceive==0 && row.IsCancel==0){
	                    return '<a href="../mrn/add_mrn?type=mrn&id=' + Base64.encode(row.MrnNo) +'" class="btn btn-xs btn-default" >Edit</a> &nbsp;';
                        }else{
                ...
                {"data": null, orderable: false, searchable: false,
                    mRender: function (data, type, row) {
                        return '<a href="../mrn/view_mrn/' + Base64.encode(row.MrnNo) +'" class="btn btn-xs btn-default" >View</a> &nbsp;';
