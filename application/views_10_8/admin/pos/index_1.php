                            ...
                            <form class="form-horizontal">
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class='col-sm-6 '><input type='number' name='mQty' id="mQty"  value='1' class='form-control input-lg' aria-describedby='sizing-addon3'></div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Sale Person</label>
...
<!--                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <h4 class="text-center">Multi Price <span class="discount_type">: <span class="label label-warning">Cash</span></span></h4>
                                        <div class="col-sm-5 input-group">
                                            <span class="input-group-addon"><input tabindex="17"  type="radio" class="prd_icheck" name="discount" value="2"></span>
                                            <input type="number" disabled min="0" step="50" pattern="[0-9]*" class="form-control" required="required"  name="disAmount" id="disAmount" placeholder="Enter discount amount" value="0">
                                        </div>
                                    </div>
