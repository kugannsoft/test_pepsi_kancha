                ...
                <div class="box">
                     <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="rank" class="control-label">Rate </label>
                                                                    <div class='starrr'></div>
                                                                    <input type="hidden" class="form-control rank2" name="rank" id="rank"  placeholder="Select rank">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">                                             
                                                                        <div class="form-group">
                                                                            <label for="barcode" class="control-label">Barcode  <span class="required">*</span></label>
