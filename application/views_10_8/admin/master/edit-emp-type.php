        ...
        <div class="row">
            <div class="col-md-8">
                <div class="form-group">
                    <label for="productCode" class="control-label">Employee Type <span class="required">*</span></label>
                    <input type="text" class="form-control" required="required" value="<?php echo $trans->EmpType?>"  name="name" id="name">
                </div>
                <div class="form-group">
                    <input type="hidden" value="<?php echo $trans->EmpTypeNo?>" name="id" id="id">
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    $('#addproductform').submit(function(e) {
        ...
        e.preventDefault();
        $.ajax({
            url: "<?php echo base_url('admin/master/editEmpType/') ?>",
            type: "POST",
