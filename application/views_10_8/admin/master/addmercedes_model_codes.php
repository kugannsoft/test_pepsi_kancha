<form id="addproductform">
    <div class="modal-header">
        ...
        <h4>Add Mercedes Model codes</h4>
    </div>
    <div class="modal-body">
        ...
        <div class="row">
            <div class="col-md-8">
                    ...
                    <input type="hidden" class="form-control" required="required"   name="makeid" id="makeid" value="1">
              
                 <div class="form-group">
                    <label for="model_code" class="control-label">Model Code <span class="required">*</span></label>
                    <input type="text" class="form-control" required="required"   name="model_code" id="model_code" maxlength ="6">
                </div>
                 <div class="form-group">
                    <label for="model_name" class="control-label">Model_Name <span class="required">*</span></label>
                    <input type="text" class="form-control" required="required"   name="model_name" id="model_name">
                </div>
...
<script>
    ...
    $('#addproductform').submit(function(e) {
        ...
        e.preventDefault();
        $.ajax({
            url: "<?php echo base_url('admin/master/addMercedesModelcodes/') ?>",
            type: "POST",
