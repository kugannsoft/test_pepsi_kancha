                ...
                <div class="form-group">
                    ...
                    <select class="form-control"  required="required" name="location" id="location">
                        ...
                        <?php foreach ($location AS $sup) { ?>
                            <option value="<?php echo $sup->location_id ?>" <?php if($sup->location_id==$_SESSION['location']){echo 'selected';} ?>><?php echo $sup->location ?></option>
                        <?php } ?>
                    </select>
                </div>
                <div class="form-group">
...
<script>
    ...
    $('#addproductform').submit(function(e) {
        ...
        e.preventDefault();
        $.ajax({
            url: "<?php echo base_url('admin/master/addRack/') ?>",
            type: "POST",
