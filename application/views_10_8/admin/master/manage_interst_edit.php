        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <select autofocus class="form-control select2" name="interestterm" id="interestterm">
                    ...
                    <?php for ($i = 0; $i <= 60; $i++) { ?>
                        <option value="<?php echo $i; ?>" <?php if($i==$trans->IntTerm){echo 'selected';} ?>><?php echo $i; ?></option>
                    <?php } ?>
                </select>
            </div>
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" required="required" value="<?php echo $trans->Interest	?>"  name="rate" id="rate">
                </div>
            </div>
                    <input type="hidden" value="<?php echo $trans->IntId?>" name="id" id="id">
...
<script>
    ...
    $('#addproductform').submit(function(e) {
        ...
        e.preventDefault();
        $.ajax({
            url: "<?php echo base_url('admin/master/editInterest/') ?>",
            type: "POST",
