...
<script type="text/javascript">
    var invoicetbl = $('#invoicetbl').dataTable({
        ...
        "ajax": {
            "url": "../Salesinvoice/loadAllEasyPayments",
            "type": "POST"
        },
        "columns":
            [
                ...
                {"data": "InvNo","visible": false,"searchable": true},
                {"data": "AccNo", orderable: false, searchable: false},
                ...
                {"data": null, orderable: false, searchable: false,
                    mRender: function (data, type, row) {
                        if(row.TotalDue <= 0){
                            ...
                            return '<label class="label label-warning">Not Completed</label>';
                        }
                    }
                },
                {
                    ...
                    "data": null, orderable: false, searchable: false,
                    mRender: function (data, type, row) {
                        return '<a href="../EasyPayment/invoicePrint?ac_no=' + row.AccNo + '" class="btn btn-sm btn-primary" >View</a> &nbsp;';
                    }
                    <?PHP  } else {?>
                    "data": null, orderable: false, searchable: false,
                    mRender: function (data, type, row) {
                        return '<a href="../EasyPayment/invoicePrint/' + row.AccNo + '" class="btn btn-sm btn-primary" disabled="disabled">View</a> &nbsp;';
                    }
                    <?php }?>
                }
            ]
