                    ...
                    <div class="row" style="background: #D0D0D0;"><br>
                        ...
                        <div class="col-md-4">
                            <form class="form-horizontal" >
                                <div class="form-group">
                                    <label for="customer" class="col-sm-4 control-label">Cus: Order No <span class="required">*</span></label>
                                    <div class="col-sm-7">
                                ...
                                <div class="form-group">
                                    <label for="customer" class="col-sm-4 control-label">Cancel Order No</label>
                                    <div class="col-sm-7">
                                        <input type="text" tabindex="1" class="form-control" value=""  name="grn_no_cancel" id="grn_no_cancel" placeholder="Type order no">
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div  class="col-md-5">
                            <form class="form-horizontal" >
                                ...
                                <div class="form-group">
                                    <label for="grnremark"class="col-sm-4 control-label">Remark<span class="required">*</span></label>
                                    <div class="col-sm-7">
...
<!--                                    <label  class="col-sm-4 control-label">JOB No<span class="required">*</span></label>-->
                                    <div class="col-sm-7">
                                        <!-- <textarea name="grnremark"  tabindex="2" id="grnremark" class="form-control"></textarea> -->
                                        <!-- <input type="hidden" tabindex="5" name="invoicenumber" id="invoicenumber" class="form-control" /> -->
                                        <input type="hidden" tabindex="6"  name="additional" value="<?php echo $jobno; ?>" id="additional" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="invoicenumber" class="col-sm-4 control-label">Total CO VAT/NBT</label>
                                    <div class="col-sm-7">
                        ...
                        <div  class="col-md-3">
                            <h4><b>Customer Order Details</b></h4>
...
<!--                                        <label class="col-sm-4 control-label">Supplier Item</label>-->
                                        <div class="col-sm-6">
                                            <input type="hidden" tabindex="8" class="prd_icheck" name="suppliercheck" value="1"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div>
    ...
    <div class="modal fade bs-payment-modal-lg" id="modelInvoice" tabindex="-1" role="dialog" aria-hidden="false">
        <div class="modal-dialog modal-lg">
            <div class="modal-content"><div class="modal-body" >
                    <?php //invoice print
                    $this->load->view('admin/customerorder/viewCustomerOrder.php',true); ?>
                </div></div>
        </div>
    </div>
</div>
