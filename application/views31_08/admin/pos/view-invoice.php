...
<div class="content-wrapper" id="app">
    <section class="content-header">
        ...
        <div class="pull-right">
         ...
         <!-- <a  class="btn btn-primary btn-lg btn-block" href="<?php echo base_url('admin') ?>/pos/print_invoice_pdf/<?php echo base64_encode($invHed->InvNo);?>" target="_blank">Print 2</a> -->
        </div>
    </section>
    ...
    <input type="hidden" name="inv" id="inv" value="<?php echo $invNo;?>">
        ...
        <table style="border-collapse:collapse;width:700px;margin:5px;font-family: Arial, Helvetica, sans-serif;" border="0">
            ...
            <table id="tblData"  style="border-collapse:collapse;width:700px;font-size:10px;margin:5px;font-family: Arial, Helvetica, sans-serif;" border="0">
                ...
                <tfoot>
                    ...
                    <!--<td></td>-->
                        <td style="text-align:right"  id="invTotal"><?php echo number_format($invHed->InvAmount,2);?></td>
                    </tr>
                    <tr id="discountRow">
      ...
      <table class="table table-hover table-bordered">
        ...
        <tr>
          <td><?php echo $invpay->InvDate?></td>
          <td><?php echo $invpay->InvPayType?></td>
          <td>:</td>
          <td class="text-right"><?php echo number_format($invpay->InvPayAmount,2)?></td>
          <td><?php echo $invpay->CusName?></td>
        </tr>
        <?php $totalpay+=$invpay->InvPayAmount;
        } ?>
        <tr>
          <td></td>
          <td><b>Total</b></td>
 ...
 <!-- print card receipt goes here -->
        ...
        <tr style="text-align:left;">
            ...
            <td>DATE</td>
            <td>:</td>
            <td id="lbldate"><?php echo ($card_pay->InvDate);?></td>
            <td>&nbsp;</td>
        </tr>
        <tr style="text-align:left;">
            <td>&nbsp;</td>
        ...
        <tr style="text-align:left;">
            ...
            <td id="lblinvno"> <?php echo ($card_pay->InvNo);?></td>
            <td colspan="2"  ></td>
            <td>&nbsp;</td>
        </tr>
        <tr style="text-align:left;">
            <td>Vehicle No</td>
            <td>:</td>
            <td colspan="2" id="lblvno"><?php  if($invVehi){echo $invVehi->RegNo;}else{ echo '-'; }?></td>
        ...
        <tr style="text-align:left;">
            <td>Amount</td>
            <td>:</td>
            <td colspan="2" id="lblamount">Rs.<?php echo number_format($card_pay->JobAmount,2);?></td>
            <td></td>
            <td></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        ...
        <tr style="text-align:left;">
            <td>Cheque No</td>
            <td>:</td>
            <td colspan="2" id="lblchequeno"><?php echo ($card_pay->InvNo);?></td>
            <td></td>
            <td></td>
            <td></td>
            <td>&nbsp;</td>
