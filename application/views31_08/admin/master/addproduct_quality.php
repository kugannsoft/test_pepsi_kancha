        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" required="required"  name="qualityName" id="qualityName">

                    <label for="shortName" class="control-label">Short Name<span class="required">*</span></label>
                    <input type="text" class="form-control" required="required"  name="shortName" id="shortName">
...
<script>
    ...
    $('#addproductform').submit(function(e) {
        ...
        e.preventDefault();
        $.ajax({
            url: "<?php echo base_url('admin/master/addProductQuality/') ?>",
            type: "POST",
