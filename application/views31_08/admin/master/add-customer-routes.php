        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="form-group">
                    <label for="productCode" class="control-label">Customer Routes <span class="required">*</span></label>
...
<script>
    ...
    $('#addproductform').submit(function(e) {
        ...
        e.preventDefault();
        $.ajax({
            url: "<?php echo base_url('admin/master/addCustomerRoute/') ?>",
            type: "POST",
