                    ...
                    <div class="box-body">
                        ...
                        <form id="filterform">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <select class="form-control" name="newsalesperson" id="newsalesperson" multiple="multiple">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div id="Report_header">
                        <table
                            style="border-collapse:collapse;width:700px;margin:5px;font-family: Arial, Helvetica, sans-serif; margin-left:160px;"
                            border="0">
                            <tr style="text-align:center;font-size:35px;font-family: Arial, Helvetica, sans-serif;">
                                <td colspan="6" style="font-size:25px;font-family: Arial, Helvetica, sans-serif;"><b>
                                        <?php echo $company['CompanyName'] ?> <?php echo $company['CompanyName2'] ?></b>
                                </td>
                            </tr>
                            <tr style="text-align:center;font-size:15px;font-family: Arial, Helvetica, sans-serif;">
                                <td colspan="6">
                                    <b><?php echo $company['AddressLine01'] ?><?php echo $company['AddressLine02'] ?><?php echo $company['AddressLine03'] ?>
                                        &nbsp;&nbsp; <?php echo $company['LanLineNo'] ?>, <?php echo $company['Fax'] ?>
                                        <?php echo $company['MobileNo'] ?></b></td>
                            </tr>
                        </table>
                    </div>
                </div>
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data) {
                ...
                drawTable(res.cr);
                var iscus = $("#customer").val();
                if (iscus != '') {

                    $('#cusName').html(res.cr[0].RespectSign + ' ' + res.cr[0].CusName);
...
function drawRow(rowData) {
    if (rowData.CreditAmount != rowData.SettledAmount) {


        var row = $("<tr/>");
        $("#saletable").append(row);

        row.append($("<td><a href='<?php echo base_url() ?>admin/payment/view_customer/" + (rowData.CusCode) + "' >" +
            rowData.RespectSign + " " + rowData.CusName + "</a></td>"));
        ...
        row.append($("<td class='totalamount' align='right'>" + accounting.formatMoney(rowData.SettledAmount) +
            "</td>"));
        row.append($("<td class='totalamount' align='right'>" + accounting.formatMoney(rowData.ReturnAmount) +
        "</td>"));
        row.append($("<td class='profit' align='right'>" + accounting.formatMoney((rowData.CreditAmount - rowData
            .SettledAmount) - rowData.ReturnAmount) + "</td>"));
    }
}
