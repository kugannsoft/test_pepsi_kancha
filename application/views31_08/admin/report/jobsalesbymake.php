                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <select class="form-control" name="product" id="product">
                                            <option value="">--select job section--</option>
                                            <?php foreach ($jobsection AS $prd) { ?>
                                                <option value="<?php echo $prd->JobSecNo ?>"><?php echo $prd->JobSection; ?></option>
                                            <?php } ?>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group" >
                                            ...
                                            <!-- <?php foreach ($make AS $loc) { ?>
                                                <option value="<?php echo $loc->make_id ?>"><?php echo $loc->make ?></option>
                                            <?php } ?> -->
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <tfoot>
                                <tr>
                                   <!--  <th></th>
                                    ...
                                    <th id="vat" style="text-align: right;color: #00aaf1;"></th>
                                    <!-- <th id="nbt" style="text-align: right;color: #00aaf1;"></th> -->
...
var subtotal = 0;
    function drawTable(data) {
        ...
        $.each(data.pro, function(key, value) {
            ...
            $("#saletable").append("<tr style='background-color:#00a678;color:#fff;'><td colspan='5'><b> SECTION : " + key + "</b></td></tr>");
            total2 = 0;
            
            $.each(value, function(key2, value2) {
                $("#saletable").append("<tr style='background-color:#50af54;color:#fff;'><td colspan='5'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b> MAKE : " + key2 + "</b></td></tr>");

                for (var i = 0; i < value2.length; i++) {
                    drawRow(value2, i);
                    gr_qty += parseFloat(value2[i].Qty);
                    var gr_cost = 0;
                    gr_net += parseFloat(value2[i].NetAmount);
                    subtotal +=gr_net;

                    if (i == (value2.length - 1)) {
                        $("#saletable").append("<tr style='background-color:#3c8dbc;color:#fff;'><td colspan='3' ></td><td><b></b></td><td class='text-right' ><b>" + accounting.formatMoney(gr_net) + "</b></td></tr>");
                        $("#saletable").append("<tr><td colspan='5'>&nbsp;</td></tr>");
                        gr_qty = 0;
                        gr_net = 0;
                        gr_pro = 0;
                    }
    ...
    function drawRow(rowData, index) {
        ...
        row.append($("<td>" + rowData[index].JobCardNo + "</td>"));
        row.append($("<td>" + rowData[index].JobInvNo + "</td>"));
        row.append($("<td>" + rowData[index].JRegNo + "</td>"));
