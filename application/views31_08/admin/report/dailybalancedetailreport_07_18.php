...
<script>
 ...
 $("#route").change(function(){
    ...
    function drawEasyCusPayRow(rowData) {
        ...
        row.append($("<td class='card' align='right'>" + accounting.formatMoney(rowData.PayAmount) + "</td>"));
        } else {
        row.append($("<td class='card' align='right'>" + accounting.formatMoney(0) + "</td>"));
        }

        row.append($("<td class='cheque' align='right'>" + accounting.formatMoney(rowData.ChequePayment) + "</td>"));
        if (rowData.PaymentType == 8){
            row.append($("<td class='bank' align='right'>" + accounting.formatMoney(rowData.PayAmount) + "</td>"));
        } else {
            row.append($("<td class='bank' align='right'>" + accounting.formatMoney(0) + "</td>"));
        }
        row.append($("<td class='oderadvance' align='right'>" + accounting.formatMoney(0) + "</td>"));
    ...
    function drawCusodercuspayCusPayRow(rowData) {
        ...
        row.append($("<td class='net' align='right'>" + accounting.formatMoney(rowData.PayAmount) + "</td>"));
        if (rowData.PayType == 1){
            row.append($("<td class='cash' align='right'>" + accounting.formatMoney(rowData.PayAmount) + "</td>"));
        } else {
            row.append($("<td class='cash' align='right'>" + accounting.formatMoney(0) + "</td>"));
        }
        if (rowData.PayType == 4){
            row.append($("<td class='card' align='right'>" + accounting.formatMoney(rowData.PayAmount) + "</td>"));
        } else {
            row.append($("<td class='card' align='right'>" + accounting.formatMoney(0) + "</td>"));
        }
        if (rowData.PayType == 3){
            row.append($("<td class='cheque' align='right'>" + accounting.formatMoney(rowData.PayAmount) + "</td>"));
        } else {
            row.append($("<td class='cheque' align='right'>" + accounting.formatMoney(0) + "</td>"));
        }
        if (rowData.PayType == 8){
            row.append($("<td class='bank' align='right'>" + accounting.formatMoney(rowData.PayAmount) + "</td>"));
        } else {
            row.append($("<td class='bank' align='right'>" + accounting.formatMoney(0) + "</td>"));
        }
