...
<script>
    ...
    function drawTable(data) {
        ...
        var row2 = $("<tr/>");
        $("#saletable").append(row2);
        row2.append($("<td style='background-color: #0d6aad'><b>Direct Invoice</b></td>"));
        row2.append($("<td style='background-color: #0d6aad'></td>"));
        row2.append($("<td style='background-color: #0d6aad'></td>"));
        ...
        var row3 = $("<tr/>");
        $("#saletable").append(row3);
        row3.append($("<td style='background-color: #289789'><b>Easy Invoice</b></td>"));
        row3.append($("<td style='background-color: #289789'></td>"));
        row3.append($("<td style='background-color: #289789'></td>"));
        ...
        var row4 = $("<tr/>");
        $("#saletable").append(row4);
        row4.append($("<td style='background-color: #62b26d'><b>Easy Payment</b></td>"));
        row4.append($("<td style='background-color: #62b26d'></td>"));
        row4.append($("<td style='background-color: #62b26d'></td>"));
        ...
        var row5 = $("<tr/>");
        $("#saletable").append(row5);
        row5.append($("<td style='background-color: #ac303c'><b>Customer Order Payment</b></td>"));
        row5.append($("<td style='background-color: #ac303c'></td>"));
        row5.append($("<td style='background-color: #ac303c'></td>"));
    ...
    function drawEasyCusPayRow(rowData) {
        ...
        row.append($("<td>" + rowData.PayDate + "</td>"));
        row.append($("<td  align='left'>Easy Payment</td>"));
    ...
    function drawCusodercuspayCusPayRow(rowData) {
        ...
        row.append($("<td>" + rowData.payDate + "</td>"));
        row.append($("<td  align='left'>Customer Order Payment</td>"));
    ...
    function drawPartRow(rowData) {
        ...
        row.append($("<td>" + rowData.InvDate + "</td>"));
        row.append($("<td>Direct Invoice</td>"));
