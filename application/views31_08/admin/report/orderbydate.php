...
<script>
    ...
    function drawRow(rowData) {
        ...
        row.append($("<td><a href='<?php echo base_url() ?>admin/Salesinvoice/view_sales_invoice/"+Base64.encode(rowData.PO_No)+"' >" + rowData.PO_No + "</a></td>"));
        ...
        row.append($("<td class='netamount' align='right'>" + status + "</td>"));
    }
    ...
    function printdiv() {
        $("#saletable").print({
            prepend:"<h3 style='text-align:center'>Date vise Order Report</h3><hr/>",
