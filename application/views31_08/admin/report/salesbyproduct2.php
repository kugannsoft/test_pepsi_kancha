    ...
    function drawTable(data) {
        ...
        $.each(data.pro, function(key, value) {
            ...
            for (var i = 0; i < value.length; i++) {
                ...
                if (i == (value.length - 1)) {
                    $("#saletable").append("<tr style='background-color:#3c8dbc;color:#fff;'><td colspan='4' >Total</td><td><b></b></td><td><b></b></td><td class='cos'>" + accounting.formatMoney(gr_qty) + "</td><td><b></b></td><td><b>" + accounting.formatMoney(gr_net) + "</b></td></tr>");
