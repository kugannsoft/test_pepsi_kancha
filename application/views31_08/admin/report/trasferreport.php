                                ...
                                <div class="col-md-4">
                                    ...
                                    <select tabindex="3" class="form-control" name="location_from" id="location_from">
                                        ...
                                        <?php } ?>
                                         ...
                                         <span class="input-group-addon">to</span>
                                          <select tabindex="3" class="form-control" name="location_to" id="location_to">
...
<script>
      ...
      totalProfit=0;
       totalStock=0;
        ...
        $.each(data, function(key, value) {
            $("#saletable").append("<tr><td colspan='14'><b>"+key+"</b></td></tr>");

            for (var i = 0; i < value.length; i++) {
                drawRow(value,i);
                 totalStock+=(parseFloat(value[i].TransQty));
                 totalCostValue+=((value[i].CostPrice)*(value[i].TransQty));
                 totalValue+=((value[i].SellingPrice)*(value[i].TransQty));
                 totalProfit+=((value[i].SellingPrice)*(value[i].TransQty))-((value[i].CostPrice)*(value[i].TransQty));
    ...
    function drawRow(rowData,index) {
       ...
       if(parseFloat(rowData[index].Stock) < rowData[index].Prd_ROL){
        ...
        var cancel = "";
        if(rowData[index].IsCancel==1){
            cancel = "<span class='label label-danger'>Canceled</span>";
        }else if(rowData[index].IsCancel==0){
        ...
        row.append($("<td>" + rowData[index].TransQty + "</td>"));
        row.append($("<td>" + rowData[index].CostPrice + "</td>"));
        row.append($("<td>" + rowData[index].SellingPrice + "</td>"));
        row.append($("<td>" + accounting.formatMoney(rowData[index].SellingPrice*rowData[index].TransQty) + "</td>"));
        row.append($("<td>" + accounting.formatMoney(rowData[index].CostPrice*rowData[index].TransQty) + "</td>"));
        row.append($("<td>" + accounting.formatMoney((rowData[index].SellingPrice*rowData[index].TransQty)-(rowData[index].CostPrice*rowData[index].TransQty)) + "</td>"));
        row.append($("<td>" + rowData[index].first_name + "</td>"));
        row.append($("<td>" + stockIn + "</td>"));
        row.append($("<td>" + cancel + "</td>"));
        row.append($("<td>" + rowData[index].Serial + "</td>"));  
    }
    function printdiv() {
        $("#saletable").print({
