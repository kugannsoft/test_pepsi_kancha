                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="col-md-1">
                                        ...
                                        <label for="isall" class="control-label">
                                            <input class="rpt_icheck" type="hidden" name="isall"> 
                                            <!-- All -->
                                        </label>
                                    </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="input-daterange input-group" id="datepicker">
                                            <input type="hidden" class="form-control" name="startdate" id="startdate"  value="<?php echo date("Y-m-d") ?>"/>
...
$("input[name='isall']").on('ifChanged', function(event){
    ...
    function drawRow(rowData) {
        ...
        row.append($("<td>" + rowData.appoimnetDate + "</td>"));
        row.append($("<td class='cashamount' align='right'>" + (rowData.CusName) + "</td>"));
        row.append($("<td class='creditamount' align='right'>" + checkNull(rowData.JRegNo) + "</td>"));
        row.append($("<td class='ccardamount' align='right'>" +checkNull(rowData.JobCardNo) + "</td>"));
        row.append($("<td class='costamount' align='right'>" + (rowData.appoimnetDate) + "</td>"));
        row.append($("<td class='totalamount' align='right'>" + (rowData.deliveryDate) + "</td>"));
        row.append($("<td class='profit' align='right'>" + (rowData.status_name) + "</td>"));
    }
