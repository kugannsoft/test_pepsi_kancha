...
<div class="content-wrapper" id="app">
  ...
  <!--   <section class="content-header">
        ...
        <div class="pull-right">
         ...
         <a  class="btn btn-primary btn-lg btn-block" href="<?php echo base_url('admin') ?>/Salesinvoice/print_invoice_pdf/<?php echo base64_encode($invHed->JobInvNo);?>" target="_blank">Print 2</a>
        </div>
    </section> -->
    ...
    <input type="hidden" name="inv" id="inv" value="<?php echo $invNo;?>">
        <div class="row"  align="center" style='margin:5px;'>
          <?php $this->load->view('admin/_templates/company_header.php',true); ?>
            <table style="border-collapse:collapse;width:690px;margin:5px;font-family: Arial, Helvetica, sans-serif;" border="0"  align="center">
            ...
            <?php if($invjob){
              ...
              $noofjob=0;$refno=0;$nextService=0;
                      ...
                      <table id="tbl_est_data" style="font-family: Arial, Helvetica, sans-serif;border-collapse:collapse;width:690px;padding:5px;font-size:13px; margin-right: 220px;" align="center" border="0"> 
                          <tbody>
                      ...
                      <br/>
                      <table style="font-family: Arial, Helvetica, sans-serif;border-collapse:collapse;width:683px;padding:2px; position: relative;bottom: 20px; margin-right: 220px;" align="center" border="0">
    ...
    <?php $this->load->view('admin/_templates/company_header_new.php',true); ?>
            ...
            <?php if($invjob){
              ...
              $noofjob=0;$refno=0;$nextService=0;
                      ...
                      <table id="tbl_est_data" style="border-collapse:collapse;width:690px;padding:5px;font-size:13px; margin-right: 220px;" align="center" border="0"> 
                          <tbody>
                            <tr style="line-height: 5px;background-color:#5d5858 !important;color:#fff !important;">
                                  <td style="font-weight:bold;width:20px;"></td>
                                  <td colspan="2" style="font-weight:bold;width:300px;">Item & Description</td>
