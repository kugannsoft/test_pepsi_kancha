        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="row" id="printArea" align="left" style='margin:5px;'>
                    ...
                    <table style="border-collapse:collapse;width:730px;font-family: Arial, Helvetica, sans-serif;" border="0"  align="left">
...
<!--                                            <br>-->
                        ...
                        <tr style="text-align:left;font-size:13px;">
                            ...
                            <td style="text-align:left;">:</td>
                            <td style="text-align:right;"><?php echo $invRep->RouteName; ?></td>
                        </tr>
                        <tr style="text-align:left;font-size:13px;">
                            ...
                            <td style="text-align:left;">:</td>
                            <td style="text-align:right;"><?php echo $invRep->RepName; ?></td>
                        </tr>
                        <tr style="text-align:left;font-size:13px;">
                        ...
                        <table id="tbl_po_data" style="border-collapse:collapse;width:730px;padding:5px;font-size:15px;" border="0">
                            <?php if($invHed->SalesInvType==2 || $invHed->SalesInvType==3){?>
                                ...
                                <tr style="background-color:#5d5858 !important; color:#fff !important; line-height:20px; border-bottom:1px solid #000000; border-top:1px solid #000000;">
                                    ...
                                    <th style="width:180px; padding:3px; color:#fff; text-align:center;">Description</th>
                                    <th style="width:60px; padding:3px; color:#fff; text-align:center;">Unit Per Case</th>
                                    ...
                                    <th style="width:120px; padding:3px; color:#fff; text-align:center;">Discount Amount</th>
                            ...
                            <?php }elseif($invHed->SalesInvType==1){?>
                                ...
                                <tr style="background-color:#5d5858 !important; color:#fff !important; line-height:20px; border:1px solid #000000;">
                                    <th style="width:80px; padding:3px; text-align:center; border:1px solid #000000;">Item Code</th>
                                    <th style="width:180px; padding:3px; text-align:center; border:1px solid #000000;">Description</th>
                                    <th style="width:60px; padding:3px; text-align:center; border:1px solid #000000;">Unit Per Case</th>
                                    <th style="width:60px; padding:3px; text-align:center; border:1px solid #000000;">Qty</th>
                                    <th style="width:60px; padding:3px; text-align:center; border:1px solid #000000;">Free Qty</th>
                                    <th style="width:80px; padding:3px; text-align:center; border:1px solid #000000;">Unit Price</th>
                                    <th style="width:80px; padding:3px; text-align:center; border:1px solid #000000;">Discount %</th>
                                    <th style="width:120px; padding:3px; text-align:center; border:1px solid #000000;">Discount Amount</th>
                                    <th style="width:80px; padding:3px; text-align:center; border:1px solid #000000;">Amount</th>
                                </tr>
                                </thead>
...
?>
                            ...
                            if($invHed->SalesInvType==2){ ?>
                                ...
                                <tr style="line-height:25px; border-top:1px solid #000000; border-right:1px solid #000000;" id="rowTotal"><td colspan="7" style="border-bottom: 1px #00000 solid;"></td><td style="text-align:right;padding: 3px; border-bottom:1px solid #000000; border-top:1px solid #000000; border-left:1px solid #000000; border-right:1px solid #000000;">Total Amount</td>
...
<!--                                    <td colspan="4" style="border-left: 1px #fff solid;border-bottom: 1px #fff solid;"></td><td style="text-align:right">Discount  </td><td id="lbltotalDicount"   style='text-align:right'>--><?php //echo number_format($invHed->SalesDisAmount,2);?><!--</td>-->
<!--                                </tr>-->
<!--                            --><?php //}?>
...
<!--                                    <td colspan="4" style="border-left: 1px #fff solid;border-bottom: 1px #fff solid;"></td><td style="font-weight:bold;text-align:right">Total  </td><td id="lbltotalNet"   style='font-weight:bold;text-align:right'>--><?php //echo number_format($invHed->SalesNetAmount,2);?><!--</td>-->
<!--                                </tr>-->
<!--                            --><?php //} ?>
...
<!--                                    <td id="lbltotalDicount"   style='text-align:right; border-bottom:1px solid #000000; border-top:1px solid #000000; border-left:1px solid #000000; border-right:1px solid #000000;'>--><?php //echo number_format($invHed->SalesDisValue,2);?><!--</td>-->
<!--                                </tr>-->
<!--                            --><?php //} else { ?>
...
<!--                                    <td id="lbltotalDicount"   style='text-align:right; border-bottom:1px solid #000000; border-top:1px solid #000000; border-left:1px solid #000000; border-right:1px solid #000000;'>--><?php //echo number_format($invHed->SalesInvAmount,2);?><!--</td>-->
<!--                                </tr>-->
<!--                            --><?php //} else { ?>
<!--                                <tr style="line-height:25px;">-->
<!--                                    <td colspan="4" style="border-left: 1px #fff solid;border-bottom: 1px #fff solid;"></td><td style="text-align:right"> </td><td id=""   style='text-align:right'></td>-->
...
foreach ($invDtl as $invdata) {
    if ($invdata->Is_Return == 1) {
        ...
        <tr style="line-height:14px; border:1px solid #000000;">
            ...
            <td style="width:80px; border-right:1px solid #000000;"><?php echo $invdata->SalesQty; ?></td>
