                            ...
                            <div class="row row-eq-height">
                                <div class="row" id="printArea" align="center" style='margin:5px;'>
                                    ...
                                    <table id="tbl_po_data" style="border-collapse:collapse;width:700px;padding:5px;font-size:13px;" border="1">
                                        ...
                                        <tr id="rowNet"><th colspan="3" style="border-left: 1px #fff solid;border-bottom: 1px #fff solid;"></th><th style="text-align:right">Net Amount  </th><th id="lbltotalNet"   style='text-align:right'><?php echo number_format($po_hed->PO_NetAmount,2)?></th></tr>
                                        <?php } ?>
