...
<script type="text/javascript">
	...
	"columns":
	        [
	            {"data": "PRN_No"},
	            {"data": "PRN_Date", searchable: false},
	            {"data": "SupName"},
	            {"data": "PRN_Cost_Amount", searchable: false},
	            {"data": "GRN_No", searchable: false},
	            {"data": "PRN_Remark", searchable: false},
                {"data": null, orderable: false, searchable: false,
                            mRender: function (data, type, row) {
                                 if(row.PRN_IsCancel==0){
                                    return '<label class="label label-success">Active</label>';
                                }else if(row.PRN_IsCancel==1){
	            ...
	            {"data": null, orderable: false, searchable: false,
                    mRender: function (data, type, row) {
                        if(row.PRN_IsCancel==0){
                        return '<a href="view_prn/' + Base64.encode(row.PRN_No) +'" class="btn btn-xs btn-primary" >View</a> &nbsp;';
                        }else{
