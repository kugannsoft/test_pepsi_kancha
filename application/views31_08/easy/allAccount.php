...
<script type="text/javascript">
    var invoicetbl = $('#invoicetbl').dataTable({
        ...
        "ajax": {
            "url": "../Salesinvoice/loadallAccounts",
            "type": "POST"
        },
        "columns":
            [
                ...
                {"data": "AccNo","visible": false,"searchable": true},
                ...
                {"data": "MobileNo"},
                {"data": "AccDate", orderable: true, searchable: false},
                {"data": null, orderable: false, searchable: false,
                    mRender: function (data, type, row) {
                        if(row.IsCreate==1){
                            return '<label class="label label-success">Created</label>';
                        }else if(row.IsCreate==0){
                            return '<label class="label label-danger">Not Created</label>';
                        }
                    }
                }
            ]
