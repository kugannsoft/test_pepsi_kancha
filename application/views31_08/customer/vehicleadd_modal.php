<form id="vehicleaddform">
	<div class="modal-header">
        ...
        <h4>Add Vehicle for <b><?php echo $cusCode; ?></b></h4>
    </div>
    	...
    	<div class="row" style="background: rgba(121, 191, 130, 0.37);">
            <div class="col-md-3">
                ...
                <div class="form-group" >
                    ...
                    <input type="text" class="form-control" name="engineNo" id="engineNo" placeholder="km">
                </div>
            </div>
            <div class="col-md-4">
                <div class="row">
                    ...
                    <div class="col-md-6" style="display:none;">
                        <div class="form-group">
                            ...
                            <input type="text"  class="form-control" name="codeColor" id="codeColor1" placeholder="Enter Code color">
                    ...
                    <div class="col-md-6" style="display:none;">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="manufactureYear" id="manufactureYear1" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-footer">
    	<input type="hidden" name="cusCode" value='<?php echo $cusCode; ?>' />
        <button id="btnsave" class="btn btn-success btn-flat" type="submit">Add vehicle</button>
    </div>
</form>
...
$.ajax({
	...
	$('#vehicleaddform').submit(function(e) {
		...
		$.ajax({
			type:"POST",
			url:"<?php echo base_url('admin/customer/savevehicle/') ?>",
			...
			success: function (data) {
                if (data == 'success') {
                    ...
                    $.notify("Vehicle already enabled.", "warning");
                    return false;
                }
            }
		});
