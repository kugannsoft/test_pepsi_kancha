...
//        
    ...
    public function saveReturn($grnHed,$invDate) {
        $invType = $_POST['invType'];
        $supCode = $_POST['cuscode'];
        $totalNet = $_POST['total_amount'];
        $invNo = $_POST['invoicenumber'];

        $invoiceUser = $_POST['invUser'];
        $invRemark = $_POST['remark'];
        $total_Ret_amount = $_POST['total_amount'];
