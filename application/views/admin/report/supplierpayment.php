                    ...
                    <div id="Report_header" >
                        <table style="border-collapse:collapse;width:700px;margin:5px;font-family: Arial, Helvetica, sans-serif; margin-left: 180px;" border="0">
                            ...
                            <tr style="text-align:center;font-size:15px;font-family: Arial, Helvetica, sans-serif;">
                                <td colspan="6"><b><?php echo $company['AddressLine01'] ?><?php echo $company['AddressLine02'] ?><?php echo $company['AddressLine03'] ?> &nbsp;&nbsp;  Tel : <?php echo $company['LanLineNo'] ?>, <?php echo $company['Fax'] ?> <?php echo $company['MobileNo'] ?></b></td>
                            </tr>
                        </table>
                    </div>
                </div>
...
$("input[name='isall']").on('ifChanged', function(event){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data){
                    ...
                    drawTable(res);
                    $('#cusName').html(res[0].TitleName+' '+res[0].SupName);$('#address1').html(res[0].Address01);
                    $('#address2').html(res[0].Address02);
    ...
    function drawRow(rowData) {
        ...
        row.append($("<td class='cashamount' align='right'>" + (rowData.SupPayNo) + "</td>"));
