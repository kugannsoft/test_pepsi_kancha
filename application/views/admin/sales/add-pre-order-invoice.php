                            ...
                            <div class="box-body">
                                <form class="form-horizontal" id="formProduct">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="checkbox" tabindex="8" class="prd_icheck" name="isreturncheck" id="isreturncheck" value="1"/>
                                        </div> -->

                                        <label class="col-sm-4 control-label">Is Return</label>
                                        <div class="col-sm-6">
                                            <input type="checkbox"  id="isreturncheck" name="isreturncheck" value="1" />
                                        </div>
                                    </div>
                                      ...
                                      <div class="form-group" id="returnsection">
                                        ...
                                        <div class="col-sm-6">
                                            <select tabindex="7" class="form-control" id="returntype">
                                            <option value="0">Select Return Type</option>
                                             <?php foreach ($return_types as $pl) { ?>
                                            <option value="<?php echo $pl->id; ?>"><?php echo $pl->type; ?></option>
                                            <?php } ?></select>
                                        </div>
                                    </div>
                                    <div class="form-group">
