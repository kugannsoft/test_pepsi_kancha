...
$config['tables']['roles']           = 'role';
$config['tables']['locations']       = 'location';
$config['tables']['companies']       = 'company';
...
$config['join']['role']     = 'role_id';
$config['join']['location'] = 'location_id';
$config['join']['company']  = 'CompanyID';
