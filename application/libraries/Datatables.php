  ...
  */
  class Datatables
  {
    ...
    */
    ...
    public function having($key_condition, $val = NULL, $side = 'both')
    {
      $this->having[] = array($key_condition, $val, $side);
      $this->ci->db->having($key_condition, $val, $side);
      return $this;
    }
