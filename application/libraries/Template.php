...
class Template {
        ...
        public function user_render($content, $data = NULL)
    {
        ...
        {
            $this->template['header']          = $this->CI->load->view('employees/_templates/header', $data, TRUE);
            $this->template['main_header']     = $this->CI->load->view('employees/_templates/main_header', $data, TRUE);
            $this->template['main_sidebar']    = $this->CI->load->view('employees/_templates/main_sidebar', $data, TRUE);
            $this->template['content']         = $this->CI->load->view($content, $data, TRUE);
            $this->template['control_sidebar'] = $this->CI->load->view('employees/_templates/control_sidebar', $data, TRUE);
            $this->template['footer']          = $this->CI->load->view('employees/_templates/footer', $data, TRUE);

            return $this->CI->load->view('employees/_templates/template', $this->template);
        }
	}
